...
return new class extends Migration
{
    ...
    {
        Schema::table('problematica_proyecto', function (Blueprint $table) {
            ...
            $table->foreign(['problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id'], '2')->references(['id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id'])->on('problematicas')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign(['problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id', 'problematica_id'], '2')->references(['id', 'id', 'id', 'id', 'id', 'id', 'id'])->on('problematicas')->onUpdate('cascade')->onDelete('restrict');
            $table->foreign(['problematica_id'], '2')->references(['id'])->on('problematicas')->onUpdate('restrict')->onDelete('restrict');
        });
    }
