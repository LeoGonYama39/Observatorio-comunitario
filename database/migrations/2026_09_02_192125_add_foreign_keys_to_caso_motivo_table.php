...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('caso_motivo', function (Blueprint $table) {
            ...
            $table->foreign(['padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id'], '2')->references(['id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id'])->on('list_padec_caso')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign(['padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id', 'padec_caso_id'], '2')->references(['id', 'id', 'id', 'id', 'id', 'id', 'id'])->on('list_padec_caso')->onUpdate('cascade')->onDelete('restrict');
            $table->foreign(['padec_caso_id'], '2')->references(['id'])->on('list_padec_caso')->onUpdate('restrict')->onDelete('restrict');
        });
    }
