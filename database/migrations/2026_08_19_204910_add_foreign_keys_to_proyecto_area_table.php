...
return new class extends Migration
{
    ...
    {
        Schema::table('proyecto_area', function (Blueprint $table) {
            ...
            $table->foreign(['area_id', 'area_id', 'area_id', 'area_id', 'area_id'], '2')->references(['id', 'id', 'id', 'id', 'id'])->on('area')->onUpdate('cascade')->onDelete('cascade');
            $table->foreign(['area_id', 'area_id', 'area_id', 'area_id', 'area_id', 'area_id', 'area_id', 'area_id', 'area_id', 'area_id'], '2')->references(['id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id', 'id'])->on('area')->onUpdate('cascade')->onDelete('restrict');
        });
    }
