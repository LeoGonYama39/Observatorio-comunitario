        ...
        <div class="form-card">
            ...
            <div class="form-grid">
                            ...
                            @else
                                @foreach ($generos as $genero)
                                    <option value="{{ $genero }}" {{ old('genero') == $genero ? 'selected' : '' }}>
                                        {{ ucfirst(str_replace('_', ' ', $genero)) }}</option>
                                @endforeach
                            @endif
                        </select>
                        ...
                        <select name="estado_civil" class="form-select">
                            ...
                            @else
                                @foreach ($estadoCivil as $estado)
                                    <option value="{{ $estado }}" {{ old('genero') == $estado ? 'selected' : '' }}>
                ...
                <div class="form-field">
                    ...
                    <input type="number" min="0" name="num_hijos" class="form-input"
                           value="{{ old('num_hijos') }}">
                    @error('num_hijos')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
                        ...
                        <select name="nv_escolar" class="form-select">
                            ...
                            @else
                                @foreach ($nvEscolar as $estado)
                                    <option value="{{ $estado }}"
                                        {{ old('nv_escolar') == $estado ? 'selected' : '' }}>
                                        {{ ucfirst(str_replace('_', ' ', $estado)) }}</option>
                                @endforeach
                            @endif
                        </select>
            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    ...
                    <div class="select-shell">
                        <select name="colonia_id" class="form-select"
                                onchange="toggleOtroField(this, 'colonia_otro_field')">
                            <option value="">Sin especificar</option>
                            @if ($colonias->isEmpty())
                                <option value="">Error al encontrar las opciones</option>
                            @else
                                @foreach ($colonias as $colonia)
                                    <option value="{{ $colonia->id }}"
                                        {{ old('colonia_id') == $colonia->nombre ? 'selected' : '' }}>
                ...
                <div class="form-field">
                    ...
                    <div class="select-shell">
                        <select name="alcaldia" class="form-select"
                ...
                <div class="form-field">
                    <label>Correo</label>
                    <input type="text" name="correo" class="form-input" maxlength="100"
                           value="{{ old('correo') }}">
                    @error('correo')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-grid">
                        ...
                        <select name="ingreso_mensual" class="form-select">
                            ...
                            @else
                                @foreach ($ingresoMensual as $estado)
                                    <option value="{{ $estado }}"
                                        {{ old('ingreso_mensual') == $estado ? 'selected' : '' }}>
                                        {{ ucfirst(str_replace('_', ' ', $estado)) }}</option>
                                @endforeach
                            @endif
                        </select>
                        ...
                        <select name="tipo_hogar" class="form-select">
                            ...
                            @else
                                @foreach ($tipoHogar as $estado)
                                    <option value="{{ $estado }}"
                                        {{ old('tipo_hogar') == $estado ? 'selected' : '' }}>
                                        {{ ucfirst(str_replace('_', ' ', $estado)) }}</option>
                                @endforeach
                            @endif
                        </select>
                        ...
                        <select name="tipo_vivienda" class="form-select">
                            ...
                            @else
                                @foreach ($tipoVivienda as $estado)
                                    <option value="{{ $estado }}"
                                        {{ old('tipo_vivienda') == $estado ? 'selected' : '' }}>
                                        {{ ucfirst(str_replace('_', ' ', $estado)) }}</option>
                                @endforeach
                            @endif
                        </select>
                ...
                <div class="form-field">
                    ...
                    <input type="number" min="0" name="habitantes_menos_18" class="form-input"
                           value="{{ old('habitantes_menos_18') }}">
                    @error('habitantes_menos_18')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-field">
                    ...
                    <input type="number" min="0" name="habitantes_mas_18" class="form-input"
                           value="{{ old('habitantes_mas_18') }}">
                    @error('habitantes_mas_18')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-field">
                    ...
                    <input type="number" min="0" name="habitantes_mas_60" class="form-input"
                           value="{{ old('habitantes_mas_60') }}">
                    @error('habitantes_mas_60')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
                </div>
            </div>
                        ...
                        <select class="form-select" onchange="addTag(this, 'servicio_medico')">
                            ...
                            @else
                                @foreach ($serviciosMedicos as $serviciosMedico)
                                    <option value="{{ $serviciosMedico->nombre }}">{{ $serviciosMedico->nombre }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
            ...
            <div class="form-grid">
                <div class="form-field full-width">
                    ...
                    <input type="text" name="saberes" class="form-input" maxlength="255"
                           value="{{ old('saberes') }}">
                    @error('saberes')
                    <span class="field-error">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-checkbox-row">
                <input type="checkbox" id="lider" name="lider" value="1"
                    {{ old('lider') ? 'checked' : '' }}>
